...
Version  : 2.6.1
Release  : 30
URL      : http://tarballs.openstack.org/oslo.messaging/oslo.messaging-2.6.1.tar.gz
Source0  : http://tarballs.openstack.org/oslo.messaging/oslo.messaging-2.6.1.tar.gz
...
%prep
%setup -q -n oslo.messaging-2.6.1
