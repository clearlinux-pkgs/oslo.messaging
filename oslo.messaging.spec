...
Version  : 4.3.0
Release  : 37
URL      : http://tarballs.openstack.org/oslo.messaging/oslo.messaging-4.3.0.tar.gz
Source0  : http://tarballs.openstack.org/oslo.messaging/oslo.messaging-4.3.0.tar.gz
...
%prep
%setup -q -n oslo.messaging-4.3.0
