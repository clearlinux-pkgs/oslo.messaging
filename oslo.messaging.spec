...
Source0  : https://tarballs.openstack.org/oslo.messaging/oslo.messaging-10.4.0.tar.gz
Source1 : https://tarballs.openstack.org/oslo.messaging/oslo.messaging-10.4.0.tar.gz.asc
...
%prep
%setup -q -n oslo.messaging-10.4.0
cd %{_builddir}/oslo.messaging-10.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574718815
...
cp %{_builddir}/oslo.messaging-10.4.0/LICENSE %{buildroot}/usr/share/package-licenses/oslo.messaging/b9a131284bb03c49a33f0ade435e87c1bff4394b
