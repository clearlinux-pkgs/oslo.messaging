...
Version  : 10.2.0
Release  : 89
URL      : https://tarballs.openstack.org/oslo.messaging/oslo.messaging-10.2.0.tar.gz
Source0  : https://tarballs.openstack.org/oslo.messaging/oslo.messaging-10.2.0.tar.gz
Source1 : https://tarballs.openstack.org/oslo.messaging/oslo.messaging-10.2.0.tar.gz.asc
...
%prep
%setup -q -n oslo.messaging-10.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567183274
