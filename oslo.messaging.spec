...
Version  : 5.10.0
Release  : 46
URL      : http://tarballs.openstack.org/oslo.messaging/oslo.messaging-5.10.0.tar.gz
Source0  : http://tarballs.openstack.org/oslo.messaging/oslo.messaging-5.10.0.tar.gz
...
%prep
%setup -q -n oslo.messaging-5.10.0
